...
if (
  ...
  !customElements.get('hvi-icon-checkmark-circle-fill')
) {
  customElements.define('hvi-icon-checkmark-circle-fill', HviIconCheckmarkCircleFill);
}
