...
export class HviIconPlayFill extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-play-fill')) {
  customElements.define('hvi-icon-play-fill', HviIconPlayFill);
}
