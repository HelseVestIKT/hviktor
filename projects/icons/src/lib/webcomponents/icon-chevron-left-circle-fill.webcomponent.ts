...
export class HviIconChevronLeftCircleFill extends HviIconBase {
...
if (
  ...
  !customElements.get('hvi-icon-chevron-left-circle-fill')
) {
  customElements.define('hvi-icon-chevron-left-circle-fill', HviIconChevronLeftCircleFill);
}
