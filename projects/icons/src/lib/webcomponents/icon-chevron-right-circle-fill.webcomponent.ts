...
export class HviIconChevronRightCircleFill extends HviIconBase {
...
if (
  ...
  !customElements.get('hvi-icon-chevron-right-circle-fill')
) {
  customElements.define('hvi-icon-chevron-right-circle-fill', HviIconChevronRightCircleFill);
}
