...
export class HviIconInformationSquare extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-information-square')) {
  customElements.define('hvi-icon-information-square', HviIconInformationSquare);
}
