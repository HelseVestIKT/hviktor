...
export class HviIconExclamationmarkTriangle extends HviIconBase {
...
if (
  ...
  !customElements.get('hvi-icon-exclamationmark-triangle')
) {
  customElements.define('hvi-icon-exclamationmark-triangle', HviIconExclamationmarkTriangle);
}
