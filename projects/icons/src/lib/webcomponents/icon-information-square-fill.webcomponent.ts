...
export class HviIconInformationSquareFill extends HviIconBase {
...
if (
  ...
  !customElements.get('hvi-icon-information-square-fill')
) {
  customElements.define('hvi-icon-information-square-fill', HviIconInformationSquareFill);
}
