...
export class HviIconArrowCirclepath extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-arrow-circlepath')) {
  customElements.define('hvi-icon-arrow-circlepath', HviIconArrowCirclepath);
}
