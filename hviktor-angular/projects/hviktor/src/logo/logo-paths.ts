...
// ---------------------------------------------------------------------------
// Shared paths — reused across all logos
// ---------------------------------------------------------------------------

/** Blue accent dots (identical in all logos) */
const ACCENT_DOTS: LogoPath[] = [
  // Top
  {
...
/** Themed dot — left of accent dots (identical in all logos) */
const THEMED_DOT: LogoPath = {
...
/** Text "HELSE" — identical in all "Helse ..." logos */
const HELSE_TEXT: LogoPath[] = [
  // H
  {
...
/** Helper to build a full logo from shared + unique parts */
function buildLogo(label: string, uniquePaths: LogoPath[]): LogoDefinition {
  return {
    viewBox: '0 0 240 61',
    width: 240,
    height: 61,
    label,
    paths: [...ACCENT_DOTS, THEMED_DOT, ...HELSE_TEXT, ...uniquePaths],
  };
}

// ---------------------------------------------------------------------------
// Unique paths per company (only the company name text after "HELSE")
// ---------------------------------------------------------------------------

/** Text "VEST" */
const VEST_TEXT: LogoPath[] = [
  // V
  {
...
export const LOGOS = {
  'helse-vest': buildLogo('Helse Vest logo', VEST_TEXT),
