...
export class HviIconPlusCircle extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-plus-circle')) {
  customElements.define('hvi-icon-plus-circle', HviIconPlusCircle);
}
