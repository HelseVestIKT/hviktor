...
if (
  ...
  !customElements.get('hvi-icon-exclamationmark-triangle-fill')
) {
  customElements.define(
    'hvi-icon-exclamationmark-triangle-fill',
    HviIconExclamationmarkTriangleFill,
  );
}
