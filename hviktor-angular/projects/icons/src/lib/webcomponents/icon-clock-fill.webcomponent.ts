...
export class HviIconClockFill extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-clock-fill')) {
  customElements.define('hvi-icon-clock-fill', HviIconClockFill);
}
