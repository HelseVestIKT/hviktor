...
export class HviIconClock extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-clock')) {
  customElements.define('hvi-icon-clock', HviIconClock);
}
