...
export class HviIconPersonPregnantFill extends HviIconBase {
  protected get path(): string {
    return 'M12 2.25C10.2051 2.25 8.75 3.70507 8.75 5.5C8.75 7.29493 10.2051 8.75 12 8.75C13.7949 8.75 15.25 7.29493 15.25 5.5C15.25 3.70507 13.7949 2.25 12 2.25ZM7.75 13C7.75 11.0134 9.66207 9.25 12 9.25C14.3379 9.25 16.25 11.0134 16.25 13V21C16.25 21.4142 15.9142 21.75 15.5 21.75H8.5C7.29281 21.75 6.3191 21.287 5.66435 20.4685C5.02762 19.6726 4.75 18.6144 4.75 17.5C4.75 16.3856 5.02762 15.3274 5.66435 14.5315C6.17742 13.8901 6.88635 13.467 7.75 13.314V13ZM8.61612 16.1161C9.10427 15.628 9.89573 15.628 10.3839 16.1161L10.5 16.2322L10.6161 16.1161C11.1043 15.628 11.8957 15.628 12.3839 16.1161C12.872 16.6043 12.872 17.3957 12.3839 17.8839L10.5 19.7678L8.61612 17.8839C8.12796 17.3957 8.12796 16.6043 8.61612 16.1161Z';
  }
}

// Register the custom element (only in browser environment)
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-person-pregnant-fill')) {
  customElements.define('hvi-icon-person-pregnant-fill', HviIconPersonPregnantFill);
}
