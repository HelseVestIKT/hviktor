...
export class HviIconMonitor extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-monitor')) {
  customElements.define('hvi-icon-monitor', HviIconMonitor);
}
