...
export class HviIconChevronUpCircle extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-chevron-up-circle')) {
  customElements.define('hvi-icon-chevron-up-circle', HviIconChevronUpCircle);
}
