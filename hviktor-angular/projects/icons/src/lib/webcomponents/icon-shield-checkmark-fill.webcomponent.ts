...
if (
  ...
  !customElements.get('hvi-icon-shield-checkmark-fill')
) {
  customElements.define('hvi-icon-shield-checkmark-fill', HviIconShieldCheckmarkFill);
}
