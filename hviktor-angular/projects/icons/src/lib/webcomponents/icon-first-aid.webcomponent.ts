...
export class HviIconFirstAid extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-first-aid')) {
  customElements.define('hvi-icon-first-aid', HviIconFirstAid);
}
