...
export class HviIconPlate extends HviIconBase {
...
if (typeof customElements !== 'undefined' && !customElements.get('hvi-icon-plate')) {
  customElements.define('hvi-icon-plate', HviIconPlate);
}
