...
export const FormsAllePakrevdExampleSource = `import { Component, signal } from '@angular/core';
import { ReactiveFormsModule, FormControl, FormGroup, Validators } from '@angular/forms';
import { HviButton, HviFieldKit, HviForms, HviRequiredTag, HviTextfield, HviValidationKit, HviValidationMessages } from '@helsevestikt/hviktor';

@Component({
  selector: 'app-forms-alle-pakrevd-example',
  standalone: true,
  imports: [HviButton, HviFieldKit, HviForms, HviRequiredTag, HviTextfield, HviValidationKit, ReactiveFormsModule],
  template: \`
