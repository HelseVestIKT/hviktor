...
@Component({
  ...
  standalone: true,
  imports: [HviForms, HviFieldKit, HviValidationKit, HviButton, HviHeading, HviParagraph, HviLabel],
  template: `
    <header class="mb-8">
      <h1 hviHeading size="xl">Forms</h1>
      <p hviParagraph>Skjemakomponenter med validering og feilmeldinger.</p>
    </header>

    <section class="mb-8">
      <h2 hviHeading size="md">Komplett skjema</h2>
