...
export const DialogStandardExampleSource = `import { Component, signal } from '@angular/core';
import { HviButton, HviDialog, HviDialogBlock, HviHeading, HviParagraph } from '@helsevestikt/hviktor';

@Component({
  selector: 'app-dialog-standard-example',
  standalone: true,
...
export class DialogStandardExampleComponent {
