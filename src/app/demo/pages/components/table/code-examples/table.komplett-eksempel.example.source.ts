...
import { HviButton, HviInput, HviLabel, HviPagination, HviSearch, HviSearchClear, HviSortableColumn, HviSuggestion, HviSuggestionDatalist, HviSuggestionOption, HviTable } from '@helsevestikt/hviktor';
...
@Component({
  ...
  standalone: true,
  imports: [HviButton, HviInput, HviLabel, HviPagination, HviSearch, HviSearchClear, HviSortableColumn, HviSuggestion, HviSuggestionDatalist, HviSuggestionOption, HviTable],
