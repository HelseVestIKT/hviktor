...
import { HviButton, HviInput, HviLabel, HviSuggestion, HviSuggestionDatalist, HviSuggestionOption, HviTable } from '@helsevestikt/hviktor';

@Component({
  selector: 'app-table-kolonnefiltrering-example',
  standalone: true,
  imports: [HviButton, HviInput, HviLabel, HviSuggestion, HviSuggestionDatalist, HviSuggestionOption, HviTable],
  template: \`
