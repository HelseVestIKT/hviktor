...
export const PaginationFaElementerExampleSource = `import { Component, signal } from '@angular/core';
...
@Component({
  ...
  template: \`
    <hvi-pagination [totalItems]="25" [pageSize]="10" [(currentPage)]="currentPage" />
  \`,
})
